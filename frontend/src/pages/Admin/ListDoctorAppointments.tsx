...
import { EstadoPersona, EstadosCita, Generos, RolPersona, TipoDocumento, type IAdmin, type ICita, type IMedico, type IPaciente, type IPersona } from "../../types";
...
const DataADMIN: IAdmin[]= [{ 
    idAdministrativo: 1,
    idPersona: DataPersons[4], // Maria Cruz - admin
    cargo: "Administrador",
...
const DataMedico: IMedico[]=[{
    idMedico:  1,
    idPersona: DataPersons[3], // Camilo Rodriguez - medico
    licencia: "ASD123",
...
const DataPatiente: IPaciente[]=[
    {
        idPaciente: 1,
        idPersona: DataPersons[0], // Juan Perez
